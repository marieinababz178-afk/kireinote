"""
kireinote YouTube 動画生成スクリプト - エアークローゼット編
-----------------------------------------
対象記事: clothes-subscription-review.md
動画: 服選びが面倒な人へ / airClosetの使い方 (約15秒 / 1920x1080)
レイアウト: Option A (左右分割) + タイトルスライドのみ全画面画像
v2 (generate_video_v2.py) からのコピー・改変版

使い方:
    python generate_video_clothes.py

出力:
    C:\\Users\\miker\\Downloads\\kireinote-clothes-subscription-15sec.mp4
...
Pexels 画像クレジット (CC0 / 商用利用可・帰属表示不要):
    stylist.jpg      - https://www.pexels.com/photo/woman-looking-at-clothes-on-the-clothing-rack-12911860/ (Mizuno K)
    delivery.jpg     - https://www.pexels.com/photo/a-person-delivering-a-boxes-7843999/ (Kampus Production)
    packing.jpg      - https://www.pexels.com/photo/close-up-of-person-packing-an-order-into-a-cardboard-box-7857523/ (Kampus Production)
    hero.jpg, hangers.jpg, happy.jpg - 既存素材 (Pexels CC0)
"""
...
OUTPUT_PATH = r"C:\Users\miker\Downloads\kireinote-clothes-subscription-15sec.mp4"

# 画像ディレクトリ
IMAGE_DIR = r"C:\Users\miker\kireinote\public\images\posts\clothes-subscription-review"
...
PEXELS_DOWNLOADS = [
    {
        "filename": "stylist.jpg",
        "url": "https://images.pexels.com/photos/12911860/pexels-photo-12911860.jpeg",
        "desc": "スライド2用: 女性が服を選ぶシーン (Mizuno K / Pexels CC0)",
    },
    {
        "filename": "delivery.jpg",
        "url": "https://images.pexels.com/photos/7843999/pexels-photo-7843999.jpeg",
        "desc": "スライド3用 (旧): 段ボール宅配 (Kampus Production / Pexels CC0)",
    },
    {
        "filename": "packing.jpg",
        "url": "https://images.pexels.com/photos/7857523/pexels-photo-7857523.jpeg",
        "desc": "スライド5用: 段ボール箱に荷物を梱包するシーン (Kampus Production / Pexels CC0)",
    },
    {
        "filename": "clothes_bag.jpg",
        "url": "https://images.pexels.com/photos/5710039/pexels-photo-5710039.jpeg",
        "desc": "スライド3用 (新): 服の束を抱える女性 (Arina Krasnikova / Pexels CC0)",
    },
    {
        "filename": "mirror_happy.jpg",
        "url": "https://images.pexels.com/photos/6347618/pexels-photo-6347618.jpeg",
        "desc": "スライド6用: 鏡の前で服を見る女性 (Liza Summer / Pexels CC0)",
    },
]
...
SLIDES = [
    ...
    },
    {
        ...
        "text": "3着セットが",
        "text2": "自宅に届く",
        "image": "clothes_bag.jpg",    # 服の束（airClosetは袋梱包なので段ボール画像から差し替え）
    },
    {
        "type": "step",
        "number": "3",
    ...
    },
    {
        ...
        "text": "気に入ったら",
        "text2": "そのまま購入もOK",
        "image": "mirror_happy.jpg",  # 鏡の前で服を見る女性（購入検討シーン）
    },
]
...
def main():
    print("=" * 60)
    print("kireinote 動画生成 - エアークローゼット編")
    print("=" * 60)
    ...
    # 一時ディレクトリに PNG を出力
    tmp_dir = tempfile.mkdtemp(prefix="kireinote_slides_clothes_")
    print(f"\n[1/4] PNGスライドを生成中...")
